    ...
    <div className="flex w-full flex-1 flex-col md:flex-row">
      <div className="mb-4 flex w-full flex-1 flex-row md:mb-0 ">
        ...
        >
          <div className="flex flex-row items-center md:mb-1">
            <h1 className="font-sans text-lg font-semibold fs-14 text-slate-800 dark:text-slate-100">
          ...
          {author.bio?.html && (
            <div className="hidden pr-2 md:block">
              <div
                className="prose fs-14 text-slate-600 dark:prose-dark dark:text-slate-300"
      ...
      {author.bio?.html && (
        <div className="mb-4 block md:hidden">
          <div className="prose fs-14 text-slate-600 dark:prose-dark " dangerouslySetInnerHTML={{ __html: author.bio?.html }} />
        </div>
      )}
    </div>
  );
